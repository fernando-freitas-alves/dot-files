...
vnoremap <silent> <C-Right> gt
nnoremap <silent> <C-Left> gT
vnoremap <silent> <C-Left> gT
...
inoremap <silent><C-s> <Esc>:<C-u>write<CR><Right>i
...
nnoremap <M-S-t>      :vs<bar>:b#<CR>
inoremap <M-S-t> <Esc>:vs<bar>:b#<CR>

" CTRL-C and CTRL-Insert are Copy
nnoremap <C-S-C> "+y
nnoremap <C-S-Insert> "+y
